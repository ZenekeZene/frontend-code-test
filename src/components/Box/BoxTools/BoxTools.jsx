...
const BoxTools = ({ box, onRemove }) => {
  ...
  return (
    <section className="box-tools" role="menu">
      <span
        className="box-tools__bgcolor box-tools__tool"
        onBlur={handleBlurBackgroundColor}
        role="menuitem"
      >
        <span
          className="box-tools__bgcolor-watch"
          style={{
            backgroundColor: box.isEditingBackgroundColor
      ...
      <span
        className="box-tools__color box-tools__tool"
      ...
      <span
        className="box-tools__remove box-tools__tool"
        onClick={onRemove}
        role="menuitem"
      ...
      <span
        className={`box-tools__edit box-tools__tool ${box.isEditingText ? "--is-editing" : ""}`}
