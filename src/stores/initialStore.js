...
const createInitialBoxes = ({ store }) => {
  ...
  addBoxToStore(screen.x - boxSize.width - boxSize.middleWidth - gapInPixels, subject);
  addBoxToStore(screen.x - boxSize.middleWidth, 'meets');
  addBoxToStore(screen.x + boxSize.width - boxSize.middleWidth + gapInPixels, anotherSubject);
};
